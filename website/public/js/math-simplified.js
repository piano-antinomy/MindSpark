...
function initializeMathPage() {
    console.log('Initializing Simplified Math Page with Three-Step Flow');
    ...
    const levelSelectionHTML = `
        ...
        <div class="level-selection-container">
            ...
            <div class="info-section">
                ...
                <p><em>Simplified Version: Basic question display without advanced features.</em></p>
            </div>
        </div>
    `;
    ...
    document.body.innerHTML = `
        <div class="container">
            <header class="math-header">
                <h1>Mathematics Practice (Simplified)</h1>
                <nav class="math-nav">
                    <a href="dashboard.html">← Back to Dashboard</a>
                    <a href="subjects.html">All Subjects</a>
                    <a href="math.html">Full Version</a>
                </nav>
            </header>
...
/**
 * Display simplified questions practice interface
 */
function displayQuestionsInterface(data) {
    const questionsHTML = `
        ...
        <div class="questions-container simplified">
            <div class="questions-header">
                <h2>${data.amcType} ${data.year} Practice (Simplified)</h2>
            ...
            <div id="questionDisplay" class="question-display simplified">
                <!-- Question content will be inserted here -->
            </div>
            
            <div class="answer-section simplified">
                <div class="answer-choices" id="answerChoices">
                    <!-- Answer choices will be inserted here -->
                </div>
            </div>
            
            <div class="practice-controls simplified">
                ...
                <button class="btn btn-info" onclick="resetPractice()">Reset</button>
            </div>
            
            <div class="simplified-note">
                <p><strong>Simplified Version:</strong> Basic question display. For advanced features, LaTeX rendering, and detailed solutions, use the <a href="math.html">Full Version</a>.</p>
            </div>
        </div>
    `;
...
/**
 * Display the current question (simplified version)
 */
function displayCurrentQuestion() {
    ...
    // Display question content (simplified - just show text)
    if (questionDisplay) {
        let questionText = question.question || 'Question text not available';
        
        // Simple text processing - remove complex formatting for simplified view
        questionText = questionText.replace(/\[asy\][\s\S]*?\[\/asy\]/g, '[Mathematical Diagram]');
        questionText = questionText.replace(/\$.*?\$/g, '[Mathematical Expression]');
        questionText = questionText.replace(/\\\(.*?\\\)/g, '[Mathematical Expression]');
        
        questionDisplay.innerHTML = `
            <div class="question-content simplified">
...
function resetPractice() {
    if (confirm('Reset your practice? All answers will be lost.')) {
